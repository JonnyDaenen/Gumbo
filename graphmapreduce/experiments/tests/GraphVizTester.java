 ...
 * @author Jonny Daenen
 */
public class GraphVizTester extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		GraphVizPlanVisualizer vis = new GraphVizPlanVisualizer();
		String dotcode = vis.visualize(plan);
...
//		System.out.println(Arrays.toString(gv.getGraph( dotcode, "png" )));
	...
	public static void main(String[] args) throws Exception {
		...
		int res = ToolRunner.run(new Configuration(), new GraphVizTester(), args);
