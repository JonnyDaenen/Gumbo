...
public class GFMapper2Generic extends GFMapper implements Serializable {
	 ...
	 */
	public GFMapper2Generic(Collection<GFExistentialExpression> expressionSet, RelationFileMapping fileMapping)
			throws GFOperationInitException {
...
//				LOG.warn("M2: " + t[0] + " ");
	...
	/**
	 * @see gumbo.compiler.resolver.operations.GFMapper#map(org.apache.hadoop.io.Text, org.apache.hadoop.mapreduce.Mapper.Context)
	 */
	@Override
