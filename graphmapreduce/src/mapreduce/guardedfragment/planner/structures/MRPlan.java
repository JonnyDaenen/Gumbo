...
//		}
	...
	private String createNode(String id, String label) {
		String output = "";
//		output += "subgraph cluster_"+id+"{" + System.getProperty("line.separator");
//		output += "style=filled;" + System.getProperty("line.separator");
//		output += "color=lightgrey;" + System.getProperty("line.separator");
//		output += "node [style=filled,color=white];" + System.getProperty("line.separator");
//		output += "map"+id+"-> reduce" + id + ";" + System.getProperty("line.separator");
//		output += "label = \""+label+"\"" + System.getProperty("line.separator");
//		output += "}" + System.getProperty("line.separator");
	...
	/**
	 * Indicates whether the temporary files and folders should be deleted after execution.
	 * @return true when the temporary files and folders should be deleted, false otherwise
	 */
