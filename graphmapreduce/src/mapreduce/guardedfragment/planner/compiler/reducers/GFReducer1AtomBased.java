...
public class GFReducer1AtomBased extends GFReducer implements Serializable {
	...
	public HashSet<Pair<Text, String>> reduce(Text key, Iterable<? extends Object> values)
		...
		for (Object v : values) {
			...
			if (t.find(";") >= 0) {
				...
				// TODO this is mainly for when we turn this thing into an
				// iterator
				if (keyFound) {
				...
				// else we collect the data
					...
					// create new object because Text object will be reduce by
					// Hadoop
	...
	/**
	 * @see mapreduce.guardedfragment.planner.structures.operations.GFReducer#reduce(org.apache.hadoop.io.Text,
	 *      java.lang.Iterable, org.apache.hadoop.mapreduce.Reducer.Context)
	 */
	@Override
	public void reduce(Text key, Iterable<Text> values, MultipleOutputs<Text, Text> mos) throws IOException,
		...
		try {
			...
			for (Object v : values) {
				...
				if (split != null) {
					...
					String atom = getAtom(id).toString();
