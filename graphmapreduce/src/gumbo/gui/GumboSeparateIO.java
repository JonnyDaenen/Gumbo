...
import gumbo.gui.gumboguiSeparateIO.DirOutWindow;
...
public class GumboSeparateIO extends JFrame {
	...
	public static void main(String[] args) {
		...
		DirOutWindow dirO = new DirOutWindow(outPathText,browseOutPathButton);
		...
		GumboMainWindowSeparateIO mainwindow = new GumboMainWindowSeparateIO(dirO,editorIQ, editorIn, outPipe,buttonQC,
				buttonSche,buttonFH,buttonFS,cbLevel);
