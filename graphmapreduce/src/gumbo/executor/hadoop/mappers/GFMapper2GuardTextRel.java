...
import gumbo.executor.hadoop.mappers.TupleIDCreator.TupleIDError;
...
public class GFMapper2GuardTextRel extends GFMapper1Identity {
	...
	/**
	 * @see gumbo.executor.hadoop.mappers.GFMapper2Identity#setup(org.apache.hadoop.mapreduce.Mapper.Context)
	 */
	@Override
